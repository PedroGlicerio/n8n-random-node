...
Após os containers estarem em execução, acesse o N8N em http://localhost:5678, autentique com o usuário e senha definidos no arquivo docker-compose.yml e adicione o nó Random ao fluxo.
```
---
